...
class Input extends PureComponent {
  ...
  render() {
    ...
    const { value, name, type, placeholder, max, min } = this.props;
    const focused = isFocused || isFilled;

    return (
      <Wrapper>
        <StyledInput name={name} value={value} type={type} onChange={this.handleChange} onBlur={this.handleBlur} onFocus={this.handleFocus} autocomplete="off" max={max} min={min} />
